...
function Register() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 bg-black/20 backdrop-blur-sm flex lg:p-24 lg:px-28 xl:p-28 xl:pb-16 xl:px-80">
        <motion.div 
            initial={{opacity : 0 , scale : 0}}
            animate={{opacity : 1 , scale : 1}}
            exit={{opacity : 0 , scale : 0}}
            transition={{duration : 0.5 , ease : "backInOut"} }
            className="flex-1 z-30 relative bg-gradient-to-t from-white via-white to-blue-100 overflow-hidden flex flex-col flex-wrap items-center rounded-xl bg-white "
        >  
