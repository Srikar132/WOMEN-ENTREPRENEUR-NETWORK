              ...
              <div className="flex flex-wrap w-full gap-5  px-3 sm:px-9 md:px-32 lg:px-80  py-5">
                  {events.map((event , index) => (
                    ...
                    >
                        ...
                        />
                        <h2 className="text-2xl text-blue-500 mb-3">{event?.title}</h2>
                        <p className="text-gray-700 mb-4">{event?.description}</p>
                        <div className="flex  mb-4">
                            <button className="flex items-center text-black px-4 py-2 rounded-lg shadow hover:bg-blue-700 transition duration-200">
                        ...
                        { (
                            <a 
                                ...
                                className="mt-4 inline-block bg-blue-500 text-white px-4 py-2 rounded-sm shadow hover:bg-blue-700"
                            >
                                Register
                            </a>
                        )}
